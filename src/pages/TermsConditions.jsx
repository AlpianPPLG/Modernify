...
const TermsConditions = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Terms and Conditions - Modernify</title>
        <meta
          name="description"
          content="Read our terms and conditions to understand the rules for using our services."
        />
        <meta
          name="keywords"
          content="terms and conditions, user agreement, website policy"
        />
